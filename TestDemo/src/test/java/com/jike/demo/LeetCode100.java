...
public class LeetCode100 {
    ...
    public void lengthOfLongestSubstring() {
        ...
        System.out.println(subString("dvdf"));
        System.out.println(subString("asjrgapa"));
    }
    ...
    private Integer subString(String s) {
        ...
        for (int i = 0; i < charsLength; i++) {
            char aChar = chars[i];
            length = handle(aChar, map, length);

            map2.clear();
            String substring = s.substring(i + 1);
            char[] chars1 = substring.toCharArray();
            for (char bChar : chars1) {
                length2 = handle(bChar, map2, length2);
            }
        }
    ...
    private int handle(char aChar, Map<Object, Object> map, int length) {
