...
public class LCode100 {
    ...
    public void lengthOfLongestSubstring() {
        System.out.println(subString("pwwkew")); // 3
        System.out.println(subString("pwkwew"));// 3
        System.out.println(subString("dvdf"));// 3
        System.out.println(subString("abcabcbb"));// 3
        System.out.println(subString("asjrgapa"));// 6
        System.out.println(subString("sjardgapa"));// 6
    ...
    private Integer subString(String s) {
        if(s == null || s.isEmpty()){
            return 0;
        }
