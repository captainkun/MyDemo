...
public class Mypan extends JPanel implements Runnable, MouseListener, MouseMotionListener, KeyListener {//这里要设置监听 {
    private int x = 300;//乌龟的初始坐标
    private int y = 100;
    private int[] m = new int[50];//气泡
    private int[] n = new int[50];
    private int[] q = new int[50];
    private int[] a = new int[300];//海水
    private int[] b = new int[300];
    private int[] c = new int[10];//金鱼
    private int[] d = new int[10];

    private int f = 0;//o就是右下，如果是1就是左下，2就是左上，3就是右上
    private int ga = 0;
